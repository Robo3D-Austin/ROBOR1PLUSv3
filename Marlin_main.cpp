 ...
 * M565 - Set Z probe's Z offset in current units. (Negative values apply to probes that extend below the nozzle.) //robo
 * M575 - Set Z probe's Z offset in current units. (Negative values apply to probes that extend below the nozzle.) + Store parameters in EEPROM //robo
...
void loop() {
  ...
  #if ENABLED(SDSUPPORT)
////SECRET START - Austin Smith 2/24/16 //robo
   #if ENABLED(SECRET_START)
  int testcode=0;
